...
# ----------------------------------------
# If ONCHIP_AUDIO_STORAGE is one of several IP cores in your
...
# ----------------------------------------
# ACDS 23.1 993 win32 2024.11.08.13:36:31
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ONCHIP_AUDIO_STORAGE"
}
...
ensure_lib                   ./libraries/ONCHIP_AUDIO_DATA/
vmap       ONCHIP_AUDIO_DATA ./libraries/ONCHIP_AUDIO_DATA/
...
alias com {
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_onchip_flash_util.v"                 -work ONCHIP_AUDIO_DATA
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_onchip_flash.v"                      -work ONCHIP_AUDIO_DATA
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_onchip_flash_avmm_data_controller.v" -work ONCHIP_AUDIO_DATA
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/ONCHIP_AUDIO_STORAGE.vhd"                                                     
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L rst_controller -L ONCHIP_AUDIO_DATA -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L fiftyfivenm $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -voptargs=+acc -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L rst_controller -L ONCHIP_AUDIO_DATA -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L fiftyfivenm $TOP_LEVEL_NAME
}
