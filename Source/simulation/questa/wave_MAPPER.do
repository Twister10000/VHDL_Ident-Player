...
add wave -noupdate -label MADI_FRAME_READY /aes10_data_mapper_vhd_tst/i1/MADI_FRAME_READY
add wave -noupdate -label MADI_FRAME_PARITY /aes10_data_mapper_vhd_tst/i1/MADI_FRAME_PARITY
...
WaveRestoreCursors {{Cursor 1} {500331 ps} 0}
...
update
WaveRestoreZoom {0 ps} {158842 ps}
