...
add wave -noupdate -label FIFO_WORD_USED -radix unsigned -childformat {{/aes10_data_mapper_vhd_tst/i1/FIFO_wrusedw(5) -radix unsigned} {/aes10_data_mapper_vhd_tst/i1/FIFO_wrusedw(4) -radix unsigned} {/aes10_data_mapper_vhd_tst/i1/FIFO_wrusedw(3) -radix unsigned} {/aes10_data_mapper_vhd_tst/i1/FIFO_wrusedw(2) -radix unsigned} {/aes10_data_mapper_vhd_tst/i1/FIFO_wrusedw(1) -radix unsigned} {/aes10_data_mapper_vhd_tst/i1/FIFO_wrusedw(0) -radix unsigned}} -subitemconfig {/aes10_data_mapper_vhd_tst/i1/FIFO_wrusedw(5) {-height 15 -radix unsigned} /aes10_data_mapper_vhd_tst/i1/FIFO_wrusedw(4) {-height 15 -radix unsigned} /aes10_data_mapper_vhd_tst/i1/FIFO_wrusedw(3) {-height 15 -radix unsigned} /aes10_data_mapper_vhd_tst/i1/FIFO_wrusedw(2) {-height 15 -radix unsigned} /aes10_data_mapper_vhd_tst/i1/FIFO_wrusedw(1) {-height 15 -radix unsigned} /aes10_data_mapper_vhd_tst/i1/FIFO_wrusedw(0) {-height 15 -radix unsigned}} /aes10_data_mapper_vhd_tst/i1/FIFO_wrusedw
...
update
WaveRestoreZoom {89293 ps} {137814 ps}
