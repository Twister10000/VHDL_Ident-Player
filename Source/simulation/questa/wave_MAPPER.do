...
add wave -noupdate -expand -group MADI -color Orange -label MADI_BLOCK_CTN /aes10_data_mapper_vhd_tst/i1/MADI_Block_CTN
add wave -noupdate -divider {New Divider}
...
add wave -noupdate -divider {New Divider}
add wave -noupdate -expand -group FIFO -color {Cornflower Blue} -label FIFO_FULL /aes10_data_mapper_vhd_tst/i1/FIFO_FULL
add wave -noupdate -expand -group FIFO -color {Cornflower Blue} -label FIFO_Empty /aes10_data_mapper_vhd_tst/i1/FIFO_EMPTY
add wave -noupdate -expand -group FIFO -color {Cornflower Blue} -label FIFO_RD_ENA_SIMU /aes10_data_mapper_vhd_tst/i1/FIFO_READ_ENA_SIMU
add wave -noupdate -expand -group FIFO -color {Cornflower Blue} -label FIFO_WRrq /aes10_data_mapper_vhd_tst/i1/FIFO_wrrq
add wave -noupdate -expand -group FIFO -color {Cornflower Blue} -label FIFO_OUT -radix hexadecimal /aes10_data_mapper_vhd_tst/i1/MADI_DATA
add wave -noupdate -expand -group FIFO -color {Cornflower Blue} -label FIFO_IN /aes10_data_mapper_vhd_tst/i1/MADI_FRAME_FIFO
...
WaveRestoreCursors {{Cursor 1} {123814 ps} 0}
...
update
WaveRestoreZoom {0 ps} {477799 ps}
